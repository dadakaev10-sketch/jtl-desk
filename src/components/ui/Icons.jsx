...
const CHANNEL_ICONS = { email: MailIcon, whatsapp: ChatIcon, telegram: PhoneIcon, web: GlobeIcon }

export function ChannelIcon({ channel, className = 'w-3.5 h-3.5' }) {
  const Comp = CHANNEL_ICONS[channel]
